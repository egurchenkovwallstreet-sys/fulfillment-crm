...
class AdminBillingDashboardSerializer(serializers.Serializer):
  ...
  combined_storage = SellerWeeklyShipmentsSerializer(required=False, allow_null=True)
...
class SupplyReportCrmOrderSerializer(serializers.Serializer):
  ...
  wb_created_at = serializers.CharField(allow_null=True)
  supply_scanned_at = serializers.CharField(allow_null=True)
  wb_sorted_at = serializers.CharField(allow_null=True)
  sticker_scanned_at_wb = serializers.BooleanField()
  was_shipped_to_wb_sc = serializers.BooleanField()
...
class SupplyReportSerializer(serializers.Serializer):
  ...
  sticker_query = serializers.CharField(allow_null=True, required=False)
