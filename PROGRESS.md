...
2. [x] **§9 Поставки** — весь цикл в **Сборке FBS** (лист → скан → ЧЗ → QR поставки), без отдельного раздела
3. [x] **§7 Xprinter** — агент на сервере: `/downloads/FulfillmentCRM-PrintAgent.exe` (~21 МБ)
