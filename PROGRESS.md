...
**Общий статус:** 📦 Операционный MVP + **Приёмка в XL** + **Ozon FBS: вкладки, склады, каталог, сборка (скан/ship)** + **фикс печати стикера на «На сборке»**  
...
| **27.08.2026** | **Сборка WB: скрыт лист подбора на «На сборке», фикс печати стикера после ЧЗ** | Ассистент |
