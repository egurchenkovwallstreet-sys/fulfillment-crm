...
**Стадия:** **🟡 Правки сборки WB:** лист подбора при смене склада FBS + автопечать стикера после ЧЗ. Окно ЧЗ — проверить на проде.
...
| **Окно ЧЗ не появляется после скана баркода** | 🔴 **Открыто** | Симптом: сброс на поле баркода. Попытки `7e620b0`…`a98af0b`. См. `тз и прогрес/2026-08-30-сборка-fbs-окно-чз.md` |
