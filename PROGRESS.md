...
**Стадия:** **🟡 Следующая задача:** тарифы по литражу (§12.5). Сборка FBS: очередь «Готовые» ✅.
...
### Приоритет 0 — новая задача
0. [ ] **§12.5 Тарифы по литражу (система 2):** выбор при приёмке, габариты → литры, 2 тарифа (хранение + отгрузка), расчёты в кабинете и `/owner/billing`. См. `тз и прогрес/2026-09-04-тарифы-по-литражу-план.md`.
