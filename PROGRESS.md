...
**Общий статус:** 📦 Операционный MVP + **Приёмка в XL** + **Ozon FBS шаг 1 (каркас)**  
**Стадия:** **Ozon FBS в работе.** План: `тз и прогрес/2026-08-27-ozon-fbs-план.md`. Параллельно в очереди: §4 UI токена WB, отправка остатков XL на WB, финансы.
...
1. [x] **Ozon FBS шаг 1** — вкладки WB/Ozon, цвета, ячейки, ключи, клиент API и счётчики дашборда. Далее: склады/каталог Ozon, сборка FBS, кабинет. План: `тз и прогрес/2026-08-27-ozon-fbs-план.md`.
