...
**Общий статус:** 📦 Операционный MVP + **Приёмка в XL** + **Ozon FBS: вкладки, склады, сборка (скан/ship)**  
**Стадия:** **Ozon FBS в работе.** Сделаны шаги 1–2 и часть 4 (синк отправлений, скан, ship). Дальше: каталог Ozon, этикетка PDF, ЧЗ, акт. План: `тз и прогрес/2026-08-27-ozon-fbs-план.md`.
...
| §4 Управление селлерами | 🟡 | Seller, склады WB, инвайты; **тарифы в UI** ✅; UI токена WB — нет (Django-admin) |
| §5 Модуль приёмки | ✅ | API + UI, needKiz, этикетки, перенос, sync названий; **хаб `/warehouse`**: каталог WB, онбординг ячеек, перенос остатков между складами FBS |
...
| §13 Дашборды и отчёты | 🟡 | KPI WB ✅; кабинет селлера ✅; **админ статистика** ✅; задолженность и отчёты д/м — нет |
...
1. [x] **Ozon FBS шаг 1–2 + сборка частично** — вкладки, ключи, склады Ozon, синк отправлений, скан в сборку, ship в доставку. Дальше: каталог, этикетка PDF, ЧЗ, акт. План: `тз и прогрес/2026-08-27-ozon-fbs-план.md`.
2. [ ] **§4 UI токена WB** — вставка персонального токена селлера в разделе «Селлеры» (инструкция в TZ §4.1). Частично уже есть в «Приёмка в XL».
...
6. [ ] UI ценовых групп в CRM (сейчас только Django-admin)
...
- [x] **Ozon FBS шаг 1–2 + сборка частично** — вкладки, ключи, склады Ozon, синк отправлений, скан в сборку, ship в доставку. Дальше: каталог, этикетка PDF, ЧЗ, акт. План: `тз и прогрес/2026-08-27-ozon-fbs-план.md`.
