...
**Стадия:** **🔨 Текущая задача:** исправление логики инвентаризации и приёмки. §12.5 тарифы по литражу — **⏸️ отложены** (ждём ответы).
...
| §12 Цены и финансы | 🟡 | **Тарифы** ✅, **отгрузки × тариф** ✅, **админ `/billing`** ✅; **система 2 по литражу** 📋 |
...
0. [ ] **Инвентаризация и приёмка:** исправление логики `/inventory` и `/intake` (режим «Факт на полке», сверка CRM/WB). См. `тз и прогрес/2026-09-05-инвентаризация-приемка.md`.

### Отложено — ждём ответы заказчика
- [ ] **§12.5 Тарифы по литражу (система 2):** 5 открытых вопросов (период хранения, габариты, уровень селлер/партия, Ozon, округление). См. `тз и прогрес/2026-09-04-тарифы-по-литражу-план.md`.
