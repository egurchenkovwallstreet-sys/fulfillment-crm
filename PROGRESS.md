...
**Дата последнего обновления:** 05.09.2026  
**Общий статус:** 📦 Операционный MVP + Ozon FBS + **кабинет владельца** (`/owner`)  
**Стадия:** **🔨 Следующая задача:** §12.5 тарифы по литражу (согласовано 06.09.2026). Инвентаризация и приёмка ✅.
...
| §12 Цены и финансы | 🟡 | **Тарифы** ✅, **отгрузки × тариф** ✅, **админ `/billing`** ✅; **система 2 по литражу** 📋 согласована |
