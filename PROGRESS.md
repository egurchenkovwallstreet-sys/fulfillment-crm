...
**Стадия:** **🟡 Ожидает проверки на проде:** окно ЧЗ после скана баркода (корень: сброс UI + сверка не с тем листом / не тем заказом). Ozon FBS шаг 5 закрыт; дальше: полировка и тесты (шаг 6).
